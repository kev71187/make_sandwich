  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved sandwich as @sandwich" do
        ...
        post :create, {:sandwich => { "title" => "invalid value" }}, valid_session
        assigns(:sandwich).should be_a_new(Sandwich)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested sandwich" do
        ...
        Sandwich.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => sandwich.to_param, :sandwich => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the sandwich as @sandwich" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Sandwich.any_instance.stub(:save).and_return(false)
        put :update, {:id => sandwich.to_param, :sandwich => { "title" => "invalid value" }}, valid_session
        assigns(:sandwich).should eq(sandwich)
      end
